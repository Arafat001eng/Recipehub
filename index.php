...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <!-- Left: Logo -->
  <a class="navbar-brand ml-5" href="http://localhost/RecipeHub/index.php">RecipeHub</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="form-inline my-2 my-lg-0 mr-5">
      <div class="dropdown">
        <a class="nav-link dropdown-toggle" style="text-decoration: none; color: #eee;" href="#" role="button"
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item active">
          <img src="image/bg4.jpg" class="d-block w-100" alt="Welcome to RecipeHub">
          <div class="carousel-caption d-none d-md-block">
            <h1 class="carousel-title">Welcome to <span>RecipeHub</span></h1>
            <p class="carousel-text">
              Create delicious recipes with ease using our interactive web application. 
              Input your favorite dishes, ingredients, and step-by-step procedures 
        ...
        <div class="carousel-item">
          <img src="image/bg3.jpg" class="d-block w-100" alt="Learn Cooking">
          <div class="carousel-caption d-none d-md-block">
            <h1 class="carousel-title">Learn <span>Cooking</span></h1>
            <p class="carousel-text">
              Whether you’re just starting or looking to sharpen your skills, 
              we provide simple, practical, and flavorful recipes that bring confidence 
              to your cooking and smiles to your table.
            </p>
          </div>
        </div>
        ...
        <!-- Slide 3 -->
        <div class="carousel-item">
          <img src="image/bg5.jpg" class="d-block w-100" alt="Share Your Recipes">
          <div class="carousel-caption d-none d-md-block">
            <h1 class="carousel-title">Share Your <span>Delicious Recipes</span></h1>
            <p class="carousel-text">
              Food is best when it’s shared. Upload your recipes, add your personal touch, 
              and inspire fellow food lovers. Every dish tells a story—let yours be heard.
            </p>
          </div>
        </div>
                ...
                <tbody>
                    ...
                    foreach ($result as $row) {
                        ...
                        <tr>
                            ...
                            <td id="recipeImage-<?= $recipeID ?>"><img src="http://localhost/RecipeHub/uploads/<?php echo $recipeImage ?>" class="img-fluid" style="height: 50px; width: 90px" alt="Recipe Image"></td>
